...
{
    public class DeAvaliacaoColaboradorParaItemListaGestaoAvaliacaoColaboradorViewModel : IMapeamento
    {
        public void Configurar()
        {
            ...
            Mapper.CreateMap<AvaliacaoColaborador, ItemListaGestaoAvaliacaoColaboradorViewModel>();
        }
    }
}