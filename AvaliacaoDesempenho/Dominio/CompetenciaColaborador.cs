...
namespace AvaliacaoDesempenho.Dominio
{
    ...
    public partial class CompetenciaColaborador
    {
        public int ID { get; set; }
        public int AvaliacaoColaborador_ID { get; set; }
        public int CompetenciaID { get; set; }
        public Nullable<int> NivelColaborador { get; set; }
        public Nullable<int> NivelRequerido { get; set; }
        public Nullable<int> NivelGestor { get; set; }
